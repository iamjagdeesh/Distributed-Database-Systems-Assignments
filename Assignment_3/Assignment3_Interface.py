...
def ParallelSort (InputTable, SortingColumnName, OutputTable, openconnection):
	...
	print("Max: " + str(max_col_val))
	print("Min: " + str(min_col_val))
	num_threads = 5
	delta = (max_col_val - min_col_val) / num_threads
